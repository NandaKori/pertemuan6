...
include("konfigurasi.php");
    ...
    if(isset($_POST["txNAMA"])){
        ...
        if($pass1==$pass2){
            ...
            $sql = "INSERT INTO tbuser(nama,email,username,passkey,iduser) VALUES('".$_POST["txNAMA"]."','$email','$user','$pass1','$nama');";
            echo $sql;
            ...
            $psn = "password tidak sama dengan konfimasi password";
        }
    }
